...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_LGUI, KC_Z, KC_X, KC_C, KC_V, KC_B, MO(2), KC_RGUI, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, RGUI(RSFT(KC_P)),
    KC_NO, KC_UP, KC_DOWN, KC_LALT, KC_LCTL, KC_SPC, MO(1), KC_ENT, KC_RSFT, RCTL(KC_SPC), KC_RALT, KC_LEFT, KC_RGHT, HYPR(KC_NO)
  ),
