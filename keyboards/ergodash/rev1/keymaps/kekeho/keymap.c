...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_LGUI, KC_Z, KC_X, KC_C, KC_V, KC_B, LT(2,KC_NO), KC_RGUI, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, RGUI(RSFT(KC_P)),
    KC_NO, KC_UP, KC_DOWN, KC_LALT, KC_LCTL, KC_SPC, TG(1), KC_ENT, KC_RSFT, RCTL(KC_SPC), KC_RALT, KC_LEFT, KC_RGHT, HYPR(KC_NO)
  ),
    ...
    KC_NO, KC_F11, KC_F12, KC_F13, KC_F14, KC_F15, KC_F16, KC_F17, KC_F18, KC_F19, KC_F20, KC_NO, KC_NO, KC_NO,
    KC_NO, KC_F21, KC_F22, KC_F23, KC_F24, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
    KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_RGUI, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_LALT,
    KC_NO, KC_NO, KC_NO, KC_LCTL, KC_NO, KC_LGUI, KC_NO, KC_NO, KC_RSFT, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO
  )
};
